...
// ------------------------------
const PROGS=[
{label:"1. Student Grade Calculator",code:`// Error`,inputs:[{label:"Student Name",type:"text",id:"st_name",default:"Alice"},
...
,
{label:"2. Calculator - Method Overloading",code:`// Error`,inputs:[{label:"First int (a)",type:"number",id:"c_a",default:"5"},
...
,
{label:"3. Circle & Rectangle - Inheritance",code:`// Error`,inputs:[{label:"Circle Radius",type:"number",id:"sh_r",default:"5.0"},
...
,
{label:"4. Wrapper Classes & Autoboxing",code:`// Error`,inputs:[{label:"Integer value",type:"number",id:"w_int",default:"100"},
...
,
{label:"5. Array Operations",code:`// Error`,inputs:[{label:"Number 1",type:"number",id:"a_n1",default:"45"},
...
,
{label:"6. Number Guessing Game",code:`// Error`,inputs:[{label:"Target Number",type:"number",id:"ng_target",default:"62"},
...
,
{label:"7. Simple Interest Calculator",code:`// Error`,inputs:[{label:"Principal Amount",type:"number",id:"si_p",default:"10000"},
...
,
{label:"8. Even or Odd Checker",code:`// Error`,inputs:[{label:"Enter a number",type:"number",id:"eo_num",default:"7"}],
run:function(vals){{
...
function renderInputs(i){
  // No inputs - programs run with defaults
}
...
function runCode(){
  ...
  out.textContent='Compiling...';out.className='output-box wait';
  ...
  setTimeout(function(){
    ...
    if(prog.inputs){
      for(var k=0;k<prog.inputs.length;k++){
        ...
        vals[inp.id]=inp.default;
      }
    }
    var result=prog.run(vals);
    out.textContent=result;out.className='output-box';
